    ...
    return (
      <div className="footer-container">
        <div className="footer-content">
          <h1 className="footer-heading">Quic<span className='footer-headingRed'>Kart</span></h1>
          <p className="footer-description">
          Explore fresh produce, pantry essentials, and gourmet treats with QuicKart. Your go-to for quick, reliable grocery shopping. Elevate your meals hassle-free!
          </p>
